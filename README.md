...
[![Product Name Screen Shot][product-screenshot]](https://github.com/NgocLinh711/eeg_web_demo.git)

## Project Team

- Mai Thi Thanh Loan — Student ID: 22520782
- Le Hong Ngoc Linh — Student ID: 22520761
- **Supervisor:** MSc. Nguyen Ho Duy Tri
...
python system.py  # Edit the main block with your CSV path and subject info
```
